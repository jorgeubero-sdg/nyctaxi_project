...
df = spark.read.format("csv").option("header", True).load("/Volumes/az_core_realstate_internal_training_catalog/00_landing_jrg/data_sources/lookup/taxi_zone_lookup.csv")
...
dt = DeltaTable.forName(spark, "az_core_realstate_internal_training_catalog.02_silver_jrg.taxi_zone_lookup")
