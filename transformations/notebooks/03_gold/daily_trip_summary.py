...
df = spark.read.table("az_core_realstate_internal_training_catalog.02_silver_jrg.yellow_trips_enriched").filter(f"tpep_pickup_datetime > '{two_months_ago_start}'")
...
df.write.mode("append").saveAsTable("az_core_realstate_internal_training_catalog.03_gold_jrg.daily_trip_summary")