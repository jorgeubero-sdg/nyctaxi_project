...
df_trips = spark.read.table("az_core_realstate_internal_training_catalog.02_silver_jrg.yellow_trips_cleansed")
...
df_join_final.write.mode("overwrite").saveAsTable("az_core_realstate_internal_training_catalog.02_silver_jrg.yellow_trips_enriched")