...
df = spark.read.table("az_core_realstate_internal_training_catalog.01_bronze_jrg.yellow_trips_raw")

# COMMAND ----------

df = df.filter("tpep_pickup_datetime >= '2025-03-01' AND tpep_pickup_datetime < '2025-09-01'")
...
df.write.mode("overwrite").saveAsTable("az_core_realstate_internal_training_catalog.02_silver_jrg.yellow_trips_cleansed")